...
The intent "the api holds no decision logic" is expressed as the enforceable proxy "the api may depend only on service interfaces and DTOs" — this does not claim ArchUnit inspects method bodies for logic.
